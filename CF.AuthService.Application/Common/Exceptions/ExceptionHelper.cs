...
namespace CF.AuthService.Application.Common.Exceptions
{
    ...
    public class ExceptionMessages
    {
        ...
        public static readonly KeyValuePair<string, string> UserNotFound = new KeyValuePair<string, string>("USER_INUSE", "User is not found. Try again.");
        public static readonly KeyValuePair<string, string> RoleNotFound = new KeyValuePair<string, string>("ROLE_NOT_FOUND", "Role is not found. Try again.");
        public static readonly KeyValuePair<string, string> FelStageNotFound = new KeyValuePair<string, string>("FEL_STAGE_NOT_FOUND", "Fel Stage is not found. Try again.");
        public static readonly KeyValuePair<string, string> ExistedUser = new KeyValuePair<string, string>("USER_EXISTED", "Existed user have same role, fel-stage and Area.");
