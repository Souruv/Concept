...
namespace CF.ConceptBrainService.Persistence.Migrations
{
    ...
    [Migration("20211013124731_newtablelevelinformationdefaultvalueandreference")]
    partial class newtablelevelinformationdefaultvalueandreference
    {
            ...
            modelBuilder.Entity("CF.ConceptBrainService.Application.Entities.LookupGenericWeightEstimate", b =>
                {
                    ...
                    b.Property<string>("LevelInformationId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("LevelInformationId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LevelInformationId1");
            ...
            modelBuilder.Entity("CF.ConceptBrainService.Application.Entities.LookupGenericWeightEstimate", b =>
                {
                    ...
                    b.HasOne("CF.ConceptBrainService.Application.Entities.LevelInformation", "LevelInformation")
                        .WithMany()
                        .HasForeignKey("LevelInformationId1");
