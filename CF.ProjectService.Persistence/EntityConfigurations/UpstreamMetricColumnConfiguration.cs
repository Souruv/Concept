...
{
    public class UpstreamMetricColumnConfiguration : BaseEntityConfiguration<UpstreamMetricColumn>
    {
        public override void Configure(EntityTypeBuilder<UpstreamMetricColumn> entityTypeBuilder)
        {
            base.Configure(entityTypeBuilder);
            entityTypeBuilder.Property(t => t.Name).IsRequired(true);
            entityTypeBuilder.Property(t => t.SPColumnName).IsRequired(true);
