...
namespace CF.ProjectService.Persistence.Migrations
{
    ...
    [Migration("20211102085114_add-table-WellCosts")]
    partial class addtableWellCosts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CF.ProjectService.Application.Entities.ProjectAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProjectAuditLogs", "prj");
                });
            ...
            modelBuilder.Entity("CF.ProjectService.Application.Entities.ProjectNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProjectNotifications", "prj");
                });
            ...
            modelBuilder.Entity("CF.ProjectService.Application.Entities.WellCost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal?>("P50Cost")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("P50OutputCost")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("P80Cost")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("P80OutputCost")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CF.ProjectService.Application.Entities.ProjectAuditLog", b =>
                {
                    b.HasOne("CF.ProjectService.Application.Entities.AppUser", "ActionByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CF.ProjectService.Application.Entities.ProjectNotification", b =>
                {
                    ...
                    b.HasOne("CF.ProjectService.Application.Entities.AppUser", "Receiver")
                        .WithMany()
                    ...
                    b.HasOne("CF.ProjectService.Application.Entities.AppUser", "Sender")
                        .WithMany()
