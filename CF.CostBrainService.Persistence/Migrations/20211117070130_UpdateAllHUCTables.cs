...
{
    public partial class UpdateAllHUCTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QTYMOBDEMOB_Mob_Demob = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    TotalDuration_Days = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    VesselType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PortableWater_MT_Day = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Duration_Days = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    No_Of_Set = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    No_Of_Pax = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefaultManpowerManHrsRate", x => x.Id);
                    table.ForeignKey(
